...
public class SoonDetailActivity extends AppCompatActivity {

    public static final String EXTRA_ID = SoonDetailActivity.class.getName() + ".EXTRA_ID";
    public static final String EXTRA_TITLE = SoonDetailActivity.class.getName() + ".EXTRA_TITLE";
    public static final String EXTRA_IMAGE_URL = SoonDetailActivity.class.getName() + ".EXTRA_IMAGE_URL";
    public static final String EXTRA_CASTS = SoonDetailActivity.class.getName() + ".EXTRA_CASTS";

    private static final Logger logger = new Logger(SoonDetailActivity.class);
    ...
    public static void actionStart(Context context, String id, String title, String imageUrl, String casts, String genres) {
        Intent intent = new Intent(context, SoonDetailActivity.class);
        ...
        mSubsMovie = mApi.getMovie(id)
                ...
                .subscribe(new Action1<Movie>() {
                    ...
                    public void call(Throwable throwable) {
                        Toast.makeText(SoonDetailActivity.this, R.string.server_error, Toast.LENGTH_SHORT).show();
                    }
                });
    }
