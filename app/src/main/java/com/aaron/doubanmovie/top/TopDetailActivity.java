...
public class TopDetailActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ID = TopDetailActivity.class.getName() + ".EXTRA_ID";
    public static final String EXTRA_TITLE = TopDetailActivity.class.getName() + ".EXTRA_TITLE";
    public static final String EXTRA_IMAGE_URL = TopDetailActivity.class.getName() + ".EXTRA_IMAGE_URL";
    public static final String EXTRA_CASTS = TopDetailActivity.class.getName() + ".EXTRA_CASTS";

    private static final Logger logger = new Logger(TopDetailActivity.class);
        ...
        mSubsMovie = mApi.getMovie(id)
                ...
                .subscribe(new Action1<Movie>() {
                    ...
                    public void call(Throwable throwable) {
                        Toast.makeText(TopDetailActivity.this, R.string.server_error, Toast.LENGTH_SHORT).show();
                    }
                });
    }
